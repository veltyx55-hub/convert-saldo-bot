...
# Link undangan grup wajib (opsional). Jika kosong, bot akan mencoba membuat
# link undangan otomatis lewat Telegram API (bot harus admin di grup tsb).
REQUIRED_GROUP_INVITE_LINK = os.environ.get("REQUIRED_GROUP_INVITE_LINK", "")
